...
Note: Do not forget to seperate paths by using ";" seperator.
```
...
```bash
- Step 1: run command line on terminal 1
php artisan serve

- Step 2: run command line on terminal 2
npm run watch
```
...
- Create a component (run command line):
